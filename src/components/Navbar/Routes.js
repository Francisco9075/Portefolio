    ...
    return (
        ...
        {/* For broswer router replace- 
            ...
            <a href="#education" onClick={props.onClick}>
                <div className="navs" onClick={()=>toggleActive(1)}>Educação</div>
            </a>
            <a href="#projects" onClick={props.onClick}>
                <div className="navs" onClick={()=>toggleActive(2)}>Projetos</div>
            </a>
            <a href="#getInTouch" onClick={props.onClick}>
                <div className="navs" onClick={()=>toggleActive(3)}>Contacta-me</div>
            </a>
